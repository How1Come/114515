    ...
    Game_Interpreter.prototype.pluginCommand = function(command, args) {
      ...
      if (command === 'ExtasyCul') {
            ...
            if(ExtasyType == "Mouth"){
                ...
                ExtasyPart = $gameVariables.value(1113)
                Critical = 0
                BaseExtasy = 0
            }
            ...
            CulExtasyPoint += CrPointBase //クリティカル加算
            ...
            $gameVariables._data[2026] = $gameVariables.value(2026) + ExtasyPointTotal
            $gameVariables._data[4992] = ExtasyPointTotal


            //拘束中の場合、拘束中快感に加算
            $gameVariables._data[414] = $gameVariables.value(414) + ExtasyPointTotal
        }
    }
})();